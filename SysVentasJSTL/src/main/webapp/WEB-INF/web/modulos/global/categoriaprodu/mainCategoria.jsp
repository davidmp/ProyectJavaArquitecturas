    ...
    <br/>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <a class="btn btn-info" href="${pageContext.request.contextPath}/formCategoria">Nuevo</a>  
                </div>
            </div>
              </form>
          </div>
          ...
          <tbody>
                <c:forEach items="${ListaCategoria}" var="dato">
                      <tr>
                        ...
                        <td>${dato.estado}</td>
                        <td align="center">
                            <a href="${pageContext.request.contextPath}/elimcat?id=${dato.idCategoria}" ><span title="Eliminar" class="glyphicon glyphicon-remove"></span></a>
                            <a href="${pageContext.request.contextPath}/formModif2Persona?id=${dato.idCategoria}" ><span title="Editar" class="glyphicon glyphicon-edit"></span></a>
