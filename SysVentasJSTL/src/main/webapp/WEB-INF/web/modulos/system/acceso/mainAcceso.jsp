  ...
  <section class="content">
    ...
    <c:if test="${!empty ListaAcceso}">
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
                <c:forEach items="${ListaAcceso}" var="dato">
                      <tr>
                        <th >1</th>
                        <td>${dato.nombre}</td>
                        <td>${dato.url}</td>
                        <td>${dato.codigoSeg}</td>
                        <td>${dato.nombremenu}</td>
                        <td align="center">${dato.nroOrden}</td>
                        <td>${dato.estado}</td>
                        <td>${dato.estadopri}</td>
                      </tr>
              </c:forEach> 
            </tbody>
            <tfoot>
