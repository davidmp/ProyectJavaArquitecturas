      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="${pageContext.request.contextPath}/idiom/?lang=es" >              
              <span class="flag-icon flag-icon-pe"></span>                                           
            </a>           
          </li>
          <li class="dropdown messages-menu">
            <a href="${pageContext.request.contextPath}/idiom/?lang=fr" >              
              <span class="flag-icon flag-icon-fr"></span>                                           
            </a>           
          </li>
          <li class="dropdown messages-menu">
            <a href="${pageContext.request.contextPath}/idiom/?lang=en" >              
