...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2018 a las 14:53:15
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `getAlmacenDelete` (IN `idAlmacenX` BIGINT(20))  BEGIN
    DECLARE regexist BIGINT(20);
	SELECT COUNT(*) INTO regexist FROM glo_almacen WHERE idAlmacen=idAlmacenX;
    
	IF regexist = 1 THEN
	DELETE FROM glo_almacen WHERE idAlmacen=idAlmacenX;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getPeriodoByPeriodo` (IN `periodox` BIGINT(20))  BEGIN
	SELECT *  FROM glo_periodo WHERE periodo=periodox;
    END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `operacionIgv` (IN `baseimp` DOUBLE)  BEGIN
	declare igv double;
	declare importe double;
	
	set igv=baseimp*0.18;
	set importe = baseimp+igv;
	
	select igv as igv, importe as total;
...
--
-- Volcado de datos para la tabla `comp_proveedores`
--

INSERT INTO `comp_proveedores` (`idProveedor`, `razonsocial`, `ruc`, `direccion`, `telefono`, `celular`, `estado`, `idPersona`, `idTipoProveedor`, `direccion_fiscal`, `idCodigoPostal`) VALUES
(1, 'Productos Union', '2020215454', 'Salida Arequipa KL-06', '951782520', '951782520', 1, 1, 1, 'Chullunquiani', 1);
...
--
-- Volcado de datos para la tabla `comp_tipo_proveedor`
--

INSERT INTO `comp_tipo_proveedor` (`idTipoProveedor`, `nombre`, `estado`) VALUES
(1, 'Tipo A', 1),
(2, 'Tipo B', 1);
...
--
-- Volcado de datos para la tabla `glo_almacen`
--

INSERT INTO `glo_almacen` (`idAlmacen`, `nombreAlmacen`, `descripcion`, `estado`, `idSucursal`) VALUES
(1, 'Snack', 'Bodegita', '1', 1);
...
INSERT INTO `glo_apertura_periodo` (`idAperturaPeriodo`, `idConfiguracion`, `idAlmacen`, `idPeriodo`, `estado`, `ip`, `idTrabajador`) VALUES
(1, 1, 1, 1, '1', '192.168.20.20', 1);
...
--
-- Volcado de datos para la tabla `glo_area_usuario`
--

INSERT INTO `glo_area_usuario` (`idAreaUsuario`, `nombre`, `estado`) VALUES
(1, 'Ventas', 1),
(2, 'Contabilidad', 1),
(3, 'Alamcen', 1);
...
--
-- Volcado de datos para la tabla `glo_cargo`
--

INSERT INTO `glo_cargo` (`idCargo`, `nombre`, `estado`) VALUES
(1, 'Vendedor', '1'),
(2, 'Almacenero', '1');
...
--
-- Volcado de datos para la tabla `glo_categoriamanufact`
--

INSERT INTO `glo_categoriamanufact` (`idCategoriamanufactura`, `nombre`, `estado`) VALUES
...
--
-- Volcado de datos para la tabla `glo_categoria_producto`
--

INSERT INTO `glo_categoria_producto` (`idCategoria`, `nombre`, `descripcion`, `estado`) VALUES
(1, 'Ferrateria', 'Productos de Construcción', 1),
(2, 'Artefactos', 'Productos Domesticos', 1);
...
--
-- Volcado de datos para la tabla `glo_codigopostal`
--

INSERT INTO `glo_codigopostal` (`idCodigoPostal`, `ubigeo`, `distrito`, `provincia`, `departamento`, `pais`) VALUES
(1, '20023045', 'Juliaca', 'San Roman', 'Puno', 'Peru'),
(2, '20023046', 'San Miguel', 'San Roman', 'Puno', 'Peru');
...
--
-- Volcado de datos para la tabla `glo_companhia`
--

INSERT INTO `glo_companhia` (`idCompanhia`, `nombre`, `razonsocial`, `direccionlegal`, `direccionref`, `telefono`, `celular`, `ruc`, `paginaweb`, `email`, `logo`, `siglas`, `replegal`) VALUES
(1, 'Unión Peruana del Norte', 'Union Peruana del Norte', 'Carretera Ñaña KM 19', 'Carretera Ñaña KM 19', '951782520', '951782520', '2013182526', 'www.upn.org', 'upn@gmail.com', 'upn.png', 'UPN', 'Bill quispe');
...
INSERT INTO `glo_configuracion` (`idConfiguracion`, `id_cuenta_igv`, `igv_porcent`) VALUES
(1, '20.10.10', 18);
...
INSERT INTO `glo_empresa` (`idEmpresa`, `razonsocial`, `descripcion`, `direccionlegal`, `direccionref`, `telefono`, `celular`, `ruc`, `paginaweb`, `email`, `logo`, `siglas`, `repLegal`, `docidentReplegal`, `nombreAnho`, `gradoReplegal`, `idCompanhia`) VALUES
(1, 'Universidad Peruana Unión', 'Institucion Educativa', 'Carretera Panamericana KM 19', 'Ñaña', '951782520', '951782520', '201318182526', 'www.upeu.edu.pe', 'upeu@upeu.edu.pe', 'upeu.png', 'UPeU', 'Clever Alvarez Turpo', '46362514', 'Reconciliación Nacional', 'Magister', 1);
...
--
-- Volcado de datos para la tabla `glo_periodo`
--

INSERT INTO `glo_periodo` (`idPeriodo`, `periodo`, `fechaInicio`, `fechaFin`) VALUES
(1, '2018', '2018-11-11', '2018-12-31');
...
(1, 'David', '-', 'mamani', 'pari', '43631917', '2018-10-01', 'M', 'Juliaca', '951782520', 'davidmp', 'LmAJembXM+g=', 'mamanipari@gmail.com', 'en'),
(5, 'Elias', 'Ramon', 'Mamani', 'Pari', '65988754', '2018-10-06', 'M', 'Av. Selva alegre Mz-G Lt-14', '951782520', 'eliasmp', 'LmAJembXM+g=', 'elias@upeu.edu.pe', 'es'),
(6, 'Raul', 'Paul', 'Mendoza', 'Peredo', '21548765', '2014-11-01', 'M', 'Av. Selva alegre Mz-G Lt-14', '951782520', 'peredo', 'LmAJembXM+g=', 'peredo@upeu.edu.pe', 'en'),
(7, 'Harley', '-', 'Sancho', 'Perez', '65847121', '2008-02-28', 'M', 'Av. Selva alegre Mz-G Lt-14', '951782520', 'sancho', 'LmAJembXM+g=', 'sancho@upeu.edu.pe', 'en'),
(8, 'Moises', '-', 'Mamani', 'Pari', '98548754', '2018-10-04', 'M', 'Av. Los Angeles', '951782520', 'moisesmp', 'LmAJembXM+g=', 'mosises@upeu.edu.pe', 'es'),
(9, 'Raul', 'Ramon', 'Mendoza', 'Pari', '26251447', '2018-10-24', 'M', 'Av. Selva alegre Mz-G Lt-14', '951782520', 'peredo2', 'LmAJembXM+g=', 'peredo@upeu.edu.pe', 'es'),
(11, 'Juan', 'Jose', 'Perez', 'Peredo', '65988759', '2018-11-20', 'M', 'Juliaca', '951782520', 'juanjose', 'LmAJembXM+g=', 'epsistemasj@upeu.edu.pe', 'es'),
(12, 'Vilma', 'Diana', 'Chino', 'Colque', '87142021', '2018-11-11', 'F', 'Juliaca', '951782520', 'diana', 'LmAJembXM+g=', 'dianacq@upeu.edu.pe', 'es');
...
--
-- Volcado de datos para la tabla `glo_sucursal`
--

INSERT INTO `glo_sucursal` (`idSucursal`, `idEmpresa`, `lugar`, `direccion`) VALUES
(1, 1, 'Juliaca', 'Carretera Arequipa KM 6');
...
INSERT INTO `glo_usuario` (`idUsuario`, `fecha_acceso`, `fecha_alta`, `ip`, `estado`, `idPersona`, `idAreaUsuario`, `idPerfil`, `idCargo`) VALUES
(1, '2018-11-11', '2018-11-11 19:05:54', '192.168.1.20', 1, 6, 1, 2, 1);
...
INSERT INTO `sys_accesos` (`idAccesos`, `idMenu`, `nombre`, `descripcion`, `url`, `codigo_seg`, `nro_orden`, `estado`, `imagen`) VALUES
(1, 2, 'Cliente', 'Reg. Cliente', '/mainClient', 'VC01', 1, '1', 'Cliente.png'),
(2, 1, 'Almacen', 'Activar Almacen', '/almMain', 'CA01', 1, '1', 'almacen.png'),
(3, 2, 'Venta', 'Reg. Venta', '/mainVenta', 'RV02', 2, '1', 'venta.png'),
(4, 1, 'Persona', 'Adm. Persona', '/perMain', 'PC02', 2, '1', 'persona.png'),
(5, 1, 'Igv. Config', 'IGV. Configuracion', '/confiMain', 'IC03', 3, '1', 'configigv.png'),
(7, 2, 'Prod.Manufact', 'Producto. Manufactura', '/manuMain', 'PM04', 4, '1', 'pmanufactura.png'),
(8, 4, 'Menu', 'Menus de Enlaces', '/sysMenu', 'SM01', 1, '1', 'menu.png'),
(9, 2, 'Cat. Producto', 'Categoria Producto', '/catProMain', 'CP02', 4, '1', 'catproducto.png'),
(10, 1, 'Producto', 'Producto Retail', '/prodMain', 'P003', 4, '1', 'producto.png'),
(11, 2, 'T. Cliente', 'Tipo cliente', '/tipoclientemain', 'TC05', 5, '1', 'tipocliente.png'),
(12, 4, 'Apertura Periodo', 'Apertura Periodo', '/ApperMain', 'AP06', 6, '1', 'aperperiodo.png'),
(13, 4, 'Sucursal', 'Sucursal ', '/sucMain', 'S004', 4, '1', 'sucursal.png'),
(14, 2, 'Cat. Manufatura', 'Categoria Manufactura', '/catManuMain', 'CM05', 6, '1', 'catmanufactura.png'),
(15, 4, 'Periodo', 'Periodo', '/periodoMain', 'P006', 7, '1', 'periodo.png'),
(16, 4, 'Acceso', 'Acceso Modulos', '/mainAcceso', '', 6, '1', 'acceso.png');
...
INSERT INTO `sys_grupo` (`idGrupo`, `nombre`, `etiqueta`, `imagen`) VALUES
(1, 'Contabilidad', 'CON', 'Contabilidad.png'),
(2, 'Ventas', 'VEN', 'ventas.png'),
(3, 'Compras', 'COM', 'compras.png'),
(4, 'General', 'GEN', 'general.png'),
(5, 'Setup', 'SET', 'setup.png');
...
INSERT INTO `sys_menu` (`idMenu`, `idGrupo`, `nombre`, `etiqueta`, `estado`, `imagen`) VALUES
(1, 4, 'Configuracion', 'COF', '1', 'Configuracion.png'),
(2, 2, 'Venta', 'VEN', '1', 'Venta.jpg'),
(3, 3, 'Compras', 'COM', '1', 'Compra.png'),
(4, 5, 'Setup', 'SET', '1', 'setup.png');
...
INSERT INTO `sys_perfiles` (`idPerfil`, `nombre`, `descripcion`, `estado`, `codigo`) VALUES
(1, 'Operario', 'Ventas', '1', '3'),
(2, 'Administrador', 'Adminsitrador systema', '1', '2'),
(3, 'Super Administrador', 'Super. Administrador', '1', '1');
...
INSERT INTO `sys_privilegios` (`idPrivilegios`, `idAccesos`, `fechaAlta`, `ip`, `estado`, `idPersonaUser`, `idUsuario`) VALUES
(1, 1, '2018-11-11 19:07:06', '192.168.1.10', '1', 1, 1),
(4, 2, '2018-11-11 19:07:36', '192.168.1.10', '1', 1, 1);
...
--
ALTER TABLE `comp_tipo_proveedor`
  MODIFY `idTipoProveedor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `glo_apertura_periodo`
  MODIFY `idAperturaPeriodo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `glo_area_usuario`
--
ALTER TABLE `glo_area_usuario`
  MODIFY `idAreaUsuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `glo_categoriamanufact`
  MODIFY `idCategoriamanufactura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `glo_codigopostal`
  MODIFY `idCodigoPostal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `glo_companhia`
--
ALTER TABLE `glo_companhia`
  MODIFY `idCompanhia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `sys_accesos`
  MODIFY `idAccesos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
